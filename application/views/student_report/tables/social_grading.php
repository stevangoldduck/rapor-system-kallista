<table border="1" id="tb_class_grade" width="100%" class="table table-striped" style="text-align:center">
	...
	<?php foreach ($student as $item) { ?>
		<tr>
			...
			<td><input type="text" class="form-control" name="ssbg_grade<?php echo $item->student_id ?>"></td>
			<td><input type="text" class="form-control" name="ssbg_remark<?php echo $item->student_id ?>"></td>
		</tr>
	<?php } ?>
	</tbody>
</table>
